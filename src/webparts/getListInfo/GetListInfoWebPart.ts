...
import GetListInfo from './components/GetListInfo';
import { IGetListInfoProps } from './components/IGetListInfoProps';
...
export default class GetListInfoWebPart extends BaseClientSideWebPart<IGetListInfoWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IGetListInfoProps> = React.createElement(
      GetListInfo,
      {
